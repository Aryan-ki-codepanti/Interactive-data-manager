...
def read_win():
	...
	my_label = tk.Label(my_frame,text='Enter complete\n file name',font = file_font1,bg = 'pale green',fg = 'Teal')
	my_label.place(relheight = 1,relwidth = 0.5,relx=0,rely=0)

	entry1 = tk.Entry(my_frame,font = file_font1)
	...
	def read_func(n):
		...
		content_label = tk.Label(read_win_popup,font = file_font3,bg = 'yellow',text = content,fg = 'navy')
		content_label.place(anchor = 'n',relx = 0.5,rely = 11/21 ,relheight = 9/21 ,relwidth = 0.8)
...
def write_win():
	...
	file_name_label = tk.Label(f1_taking_filename,font = file_font1,fg = 'green',text = 'Enter full \n name of file',bg = 'yellow')
	file_name_entry = tk.Entry(f1_taking_filename,font = file_font1)
